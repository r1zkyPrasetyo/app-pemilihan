	...
	<div id="page-container" class="fade">
			...
			<div class="container">
				<div class="navbar-header">
					...
					<a href="<?php echo base_url('home');?>" class="navbar-brand">
						...
						<span class="brand-text">
							<span class="text-theme">Pemutakhiran Data</span> <?php echo $desa;?>
						</span>
					</a>
				</div>
				<div class="collapse navbar-collapse" id="header-navbar">
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="nav-item dropdown">
							<a class="nav-link" href="#pilkades" data-click="scroll-to-target" data-scroll-target="#pilkades" data-toggle="dropdown">Pemutakhiran Data <b class="caret"></b></a>
						...
						<li class="nav-item"><a class="nav-link" href="#perangkat" data-click="scroll-to-target">Pengurus</a></li>
		...
		<div id="home" class="content has-bg home">
			...
			<div class="container home-content" style="top: 40%;">
				...
				<h3>Web Informasi Pemutakhiran Data <?php echo $desa;?></h3>
				<p>
		...
		<div id="sk_panitia" class="content bg-silver-lighter" data-scrollview="true">
			<div class="container">
				<h2 class="content-title">Panitia Pemutakhiran Data <?php echo $desa;?></h2>
		...
		<div id="bumdes" class="content" data-scrollview="true">
			<div class="container">
				<h2 class="content-title">TIM PENGURUS GUNUNG MULIA, <?php echo $sis_pem . ' '. $desa;?></h2>
				<div class="row">
						<?php 
		...
		<div id="kegiatan" class="content" data-scrollview="true">
			<div class="container" data-animation="true" data-animation-type="fadeInDown">
				...
				<p class="content-desc">
					Dokumentasi Kegiatan Tahapan Pemutakhiran Data <?php echo date('Y') ?>
				</p>
